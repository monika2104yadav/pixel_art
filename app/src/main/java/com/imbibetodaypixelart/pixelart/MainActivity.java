package com.imbibetodaypixelart.pixelart;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void addDrawerItems() {
        ...
        DrawerMenuItem drawerExport = new DrawerMenuItem(R.drawable.menu_export, R.string.menu_export) {
            ...
            public void execute() {
                ...
                filename = "IMG" + calendar.get(Calendar.YEAR) + calendar.get(Calendar.MONTH)
    ...
    public void screenShot(View view, String filename) {
        ...
        File imageFolder = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_PICTURES),
    ...
    // Initialize the "pixels" (basically sets OnLongClickListener on them)
    private void initPixels (){
        ...
        for (int i = 0; i < paper.getChildCount(); i++) {
            ...
            for (int j = 0; j < l.getChildCount(); j++) {
                ...
                // Sets OnLongClickListener to be able to select current color
                // based on the pixel's color.
